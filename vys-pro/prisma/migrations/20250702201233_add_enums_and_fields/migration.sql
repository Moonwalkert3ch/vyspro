...
ALTER TABLE "listing_models"
  ADD COLUMN "model_status" "ModelStatus" NOT NULL DEFAULT 'PENDING'::"ModelStatus";
...
ALTER TABLE "transactions"
  ADD COLUMN "transaction_status" "TransactionStatus" NOT NULL DEFAULT 'PENDING'::"TransactionStatus";
...
ALTER TABLE "listings"
  ADD COLUMN "delivery_method" "DeliveryMethod" NOT NULL DEFAULT 'PICKUP'::"DeliveryMethod",
